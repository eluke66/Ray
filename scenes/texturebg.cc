...
Scene* texturebg()
{
  ...
  //scene->setBackground(new TextureBackground( "/home/luke/Images/dsc00021.jpg" ) );
  scene->setBackground(new TextureBackground( "textures/land_ocean_ice_cloud_1024.ppm" ) );
